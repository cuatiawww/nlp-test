...
export default function SocialMediaIcon({ platform, size = "sm", className = "" }: Props) {
  ...
  if (lower.includes("mastodon")) {
    return (
      <span
        style={containerStyle}
        className={`inline-flex shrink-0 items-center justify-center rounded-full bg-[#6364FF] shadow-sm overflow-hidden ${className}`}
        title="Mastodon"
      >
        <svg viewBox="0 0 24 24" fill="white" className="h-[75%] w-[75%]">
          <path d="M23.268 5.313c-.35-2.578-2.617-4.61-5.304-5.004C17.51.244 15.12 0 12.001 0c-3.118 0-5.508.244-5.963.309C3.351.703 1.084 2.735.734 5.313.36 8.08.318 11.08.32 12.827c.004 2.174.088 4.346.248 6.513.255 3.447 2.668 6.326 6.02 7.18 2.875.732 5.92.656 8.795-.224 0 0 .04-.012.08-.027l-.02-1.89c-.004-.37-.303-.668-.673-.662-1.78.03-3.553-.163-5.28-.574-1.503-.357-1.83-1.464-1.868-2.023l-.004-.067c.928.232 1.87.397 2.818.495 1.545.158 3.097.126 4.64-.096 3.123-.45 5.86-2.613 6.44-5.717.65-3.483.77-6.98.77-10.422 0-1.748-.04-4.747-.417-7.514zm-4.767 11.23h-2.54V9.61c0-1.458-.616-2.203-1.848-2.203-1.353 0-2.03.876-2.03 2.628v3.818H9.92V10.035c0-1.752-.677-2.628-2.03-2.628-1.232 0-1.848.745-1.848 2.203v6.933H3.502V9.337c0-1.458.374-2.617 1.12-3.477.78-.89 1.802-1.344 3.067-1.344 1.465 0 2.565.56 3.298 1.68l.965 1.62.964-1.62c.733-1.12 1.833-1.68 3.298-1.68 1.265 0 2.287.454 3.067 1.344.746.86 1.12 2.019 1.12 3.477v7.206z"/>
        </svg>
      </span>
    );
  }
