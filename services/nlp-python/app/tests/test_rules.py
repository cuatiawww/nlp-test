...
class ClassificationRulesTest(unittest.TestCase):
    ...
    def test_who_aliases_are_used_for_entity_matching(self):
        ...
        self.assertEqual(extract_disease_mentions("Program demam berdarah di Laos", concepts), ["dengue fever"])
    ...
    def test_unicode_who_alias_is_not_dropped(self):
        ...
        self.assertEqual(extract_disease_mentions("พบผู้ป่วยไข้เลือดออก", concepts), ["dengue fever"])
